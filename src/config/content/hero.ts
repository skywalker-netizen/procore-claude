...
export const HERO_CONTENT: VariantContent<HeroContent> = {
  ...
  general: {
    ...
    subtitle:
      'You\'re outgrowing paper binders and simple digital safety forms, but "good enough" safety is not an option and you don\'t have time for "Enterprise" bloat that takes six months to deploy.',
    description:

      ...
      <section className="section-padding" style={{ background: 'hsl(var(--gray-100))' }}>
        <div className="section-inner grid-2">
          <div>
            ...
            <div className="numbered-feature"><div className="numbered-feature-icon red"><FileText size={20} /></div><div><h4>The "Flat" Form Trap</h4><p>Procore Static fillable PDFs trap your data in a document, making it invisible to analytics and frustrating for field teams to fill on small screens.</p></div></div>
            <div className="numbered-feature"><div className="numbered-feature-icon lime"><Zap size={20} /></div><div><h4>Intelligent Dynamic Fields</h4><p>SALUS Forms are mobile-first and smart. They adapt based on user input—requiring photo evidence for failed checks and skipping irrelevant sections automatically.</p></div></div>
            <div className="numbered-feature"><div className="numbered-feature-icon blue"><MessageSquare size={20} /></div><div><h4>Beyond Pass/Fail Context</h4><p>Use smart form logic and voice-to-text to capture the "why" behind safety issues. Get rich context that flat Procore PDFs simply can't provide.</p></div></div>
          ...
          <div className="tech-table-wrapper">
            <div className="tech-table">
              ...
              <div className="tech-table-row">
                ...
                <div className="tech-table-cell benefit"><span className="check"><Check size={12} /></span>No double setup for new jobsites.</div>
              </div>
              <div className="tech-table-row">
                <div className="tech-table-cell module">Documents</div>
                <div className="tech-table-cell input">Signed Forms & PDFs</div>
                <div className="tech-table-cell benefit"><span className="check"><Check size={12} /></span>Automated archival for 100% audit readiness.</div>
              </div>
              <div className="tech-table-row">
                <div className="tech-table-cell module">Manpower Logs</div>
                <div className="tech-table-cell input">Worker Sign-ins</div>
                <div className="tech-table-cell benefit"><span className="check"><Check size={12} /></span>Effortless transfer of headcount to Daily Logs.</div>
              </div>
              <div className="tech-table-row">
                <div className="tech-table-cell module">Photos</div>
                <div className="tech-table-cell input">Hazard Evidence</div>
                <div className="tech-table-cell benefit"><span className="check"><Check size={12} /></span>Visual context for RFIs and Observations.</div>
              </div>
              <div className="tech-table-row">
                <div className="tech-table-cell module">Tasks</div>
                <div className="tech-table-cell input">Corrective Actions</div>
                <div className="tech-table-cell benefit"><span className="check"><Check size={12} /></span>Issues flagged in SALUS become Procore Tasks.</div>
              </div>
            </div>
          </div>
        </div>

      ...
      <section className="section-padding" style={{ background: 'hsl(var(--gray-100))' }}>
        <div className="section-inner grid-2">
          <div>
            ...
            <div className="numbered-feature"><div className="numbered-feature-icon red"><FileText size={16} /></div><div><h4>The "Flat" Form Trap</h4><p>Procore Static fillable PDFs trap your data in a document, making it invisible to analytics and frustrating for field teams to fill on small screens.</p></div></div>
            <div className="numbered-feature"><div className="numbered-feature-icon lime"><Zap size={16} /></div><div><h4>Intelligent Dynamic Fields</h4><p>SALUS Forms are mobile-first and smart. They adapt based on user input—requiring photo evidence for failed checks and skipping irrelevant sections automatically.</p></div></div>
            <div className="numbered-feature"><div className="numbered-feature-icon"><MessageSquare size={16} /></div><div><h4>Beyond Pass/Fail Context</h4><p>Use smart form logic and voice-to-text to capture the "why" behind safety issues. Get rich context that flat Procore PDFs simply can't provide.</p></div></div>

import { Link, Zap, Grid3X3, MessageSquare, CircleAlert, LayoutGrid, Clock, XSquare, Target, Bell, User, Globe } from "lucide-react";
...
const Index = () => {
  return (
    <>
        ...
        <div className="hero-inner">
          <div>
            <div className="badge">
              ...
              SYNCED WITH THE FIELD
            </div>
            <h1 className="hero-title">
              Your Procore<br />Investment.<br />
            ...
            <p className="hero-description">
              Salus is the field engine that powers Procore's office brain. Two Platforms. One Seamlessly Integrated System.
            </p>
          ...
          <div className="demo-card">
            ...
            <p className="form-footer">
              Join GCs like <a href="#">Broccolini</a> and <a href="#">Willmeng</a> who trust SALUS to capture field data for their Procore instance.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="integration-inner">
          <div className="integration-content">
            ...
            <p className="integration-description">
              We don't just "link" to Procore; we inhabit it. Our integration maps directly to your critical project modules for a seamless user experience.
            </p>
            ...
            <div className="feature-item">
              ...
              <div className="feature-text">
                <h4>Salus as Field Engine</h4>
                <p>Safety data flows seamlessly from field to office.</p>
              </div>
            </div>
          </div>
          <div className="integration-diagram">
            <div className="diagram-header">
              ...
              <div className="diagram-brand">
                ...
                <div className="brand-icon salus">
                  <div style={{ width: 12, height: 12, background: 'hsl(var(--navy))', borderRadius: 3 }}></div>
                </div>
            ...
            <div className="diagram-rows">
              <div className="diagram-row">
                ...
                <div className="diagram-item right">Auto-Creation</div>
              </div>
              <div className="diagram-row">
                ...
                <div className="diagram-item right">Signed Forms</div>
              </div>
              <div className="diagram-row">
                ...
                <div className="diagram-item right">Headcount Sync</div>
              </div>
              <div className="diagram-row">
                ...
                <div className="diagram-item right">Hazard Visuals</div>
              </div>
              <div className="diagram-row">
                ...
                <div className="diagram-item right" style={{ background: '#ff6b6b' }}>Actions</div>
              </div>
            </div>
        ...
        <div className="section-inner grid-2">
            ...
            <div className="dashboard-card">
              <div className="dashboard-header">
                <div className="dashboard-header-left">
                  ...
                  <div>
                    <div className="compliance-title">Site Compliance</div>
                    <div className="compliance-status">ALL SYSTEMS OPERATIONAL</div>
                  </div>
                </div>
              ...
              <div className="dashboard-grid">
                <div className="dashboard-widget">
                  <div className="widget-header">
                    ...
                    <div className="widget-date">TODAY</div>
                  </div>
                  <div className="worker-list">
                    <div className="worker-item">
                      <div className="worker-avatar">JD</div>
                      <div className="worker-info">
                        <div className="worker-name">John D.</div>
                        <div className="worker-role">FOREMAN</div>
                      </div>
                    ...
                    <div className="worker-item">
                      ...
                      <div className="worker-info">
                        <div className="worker-name">Maria R.</div>
                        <div className="worker-role">ELECTRICIAN</div>
                      </div>
                      <div className="worker-status green"></div>
                    </div>
                    <div className="worker-item">
                      <div className="worker-avatar">TS</div>
                      <div className="worker-info">
                        <div className="worker-name">Tom S.</div>
                        <div className="worker-role">LABORER</div>
                      </div>
                ...
                <div className="dashboard-widget">
                  <div className="widget-header">
                    ...
                    <div className="widget-date">REAL-TIME</div>
                  </div>
                  <div className="asset-list">
                    <div className="asset-item">
                      <div className="asset-name">Crane-01</div>
                      <div className="asset-bar-container">
                        <div className="asset-bar">
                          <div className="asset-bar-fill high" style={{ width: '95%' }}></div>
                        </div>
                        <div className="asset-percent">95%</div>
                      </div>
                    </div>
                    <div className="asset-item">
                      <div className="asset-name">Forklift-02</div>
                      <div className="asset-bar-container">
                        <div className="asset-bar">
                    ...
                    <div className="asset-item">
                      <div className="asset-name">Backhoe-03</div>
                      <div className="asset-bar-container">
                        <div className="asset-bar">
                          <div className="asset-bar-fill high" style={{ width: '88%' }}></div>
                        </div>
                        <div className="asset-percent">88%</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="dashboard-widget corrective-widget">
                  <div className="corrective-header">
                    ...
                    <div className="resolution-rate">RESOLUTION RATE: <strong>98%</strong></div>
                  </div>
                  <div className="corrective-items">
                    <div className="corrective-item">
                      <div className="corrective-avatar">
                        <User size={20} stroke="rgba(255,255,255,0.5)" />
                      </div>
          ...
          <div>
            ...
            <h2 className="section-title">
              Shatter the Silos,<br />
              <span className="highlight">Reduce risk.</span>
            </h2>
            <p className="section-subtitle">
              Procore handles the project lifecycle. <span className="highlight">Salus handles the people, the gear, and the compliance heartbeat.</span>
            </p>
            <div className="feature-block">
              ...
              <div>
                ...
                <p>Centralize everything from training logs to certificates in one live hub. No more risk hidden in "lost" spreadsheets or siloed email threads.</p>
              </div>
            </div>
            <div className="feature-block">
              <div className="feature-block-icon">
              ...
              <div>
                ...
                <p>Close the gap between field reports and office repairs. Our two-way communication ensures every hazard is addressed and verified in real-time.</p>
              </div>
            </div>
            <div className="feature-block">
              <div className="feature-block-icon">
              ...
              <div>
                ...
                <p>Use smart form logic and voice-to-text to capture the "why" behind safety issues. Get rich context that flat Procore PDFs simply can't provide.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding" style={{ background: 'hsl(var(--background))' }}>
        <div className="section-inner grid-2">
          <div>
            ...
            <h2 className="section-title">
              Beyond Static<br />PDFs:<br />
              <span className="highlight">Intelligent Forms.</span>
            </h2>
            <div className="numbered-feature">
              ...
              <div>
                <h4>1. The "Flat" Form Trap</h4>
                <p>Procore Static fillable PDFs trap your data in a document, making it invisible to analytics and frustrating for field teams to fill on small screens.</p>
              </div>
            </div>
            <div className="numbered-feature">
              ...
              <div>
                <h4>2. Intelligent Dynamic Fields</h4>
                <p>SALUS Forms are mobile-first and smart. They adapt based on user input—requiring photo evidence for failed checks and skipping irrelevant sections automatically.</p>
              </div>
            </div>
            ...
            <div className="phone-wrapper">
              ...
              <div className="phone-mockup">
                <div className="phone-screen dark">
                  <div className="smart-form-mockup">
                    <div className="smart-form-header">
                      <span>11:57</span>
                      <span>📶 🔋 68</span>
                    </div>
                    <div className="smart-form-title-bar">
                      <h5>TCP/LCT FLRA (Risk Assessment)</h5>
                      <span>✕</span>
                    </div>
                    <div className="smart-form-field">
                      <label>Type of Roadway/Work <span>✕</span></label>
                    </div>
                    <div className="smart-form-search">🔍 Search</div>
                    <div className="smart-form-options">
                      <div className="smart-form-option selected">
                        <div className="checkbox"></div>
                        2-Lane, 2 Way Roadway
                      </div>
                      <div className="smart-form-option">
                        <div className="checkbox"></div>
                        Multilane Undivided Roadway
                      </div>
                      <div className="smart-form-option">
                        <div className="checkbox"></div>
                        Multilane Divided Roadway
                      </div>
                    </div>
                    <div className="workflow-badge">
                      ...
                      <div className="text">
                        WORKFLOW TRIGGERED
                        <span>PROCORE PROJECT TASK CREATED</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="section-inner grid-2">
          <div>
            ...
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, marginBottom: 40 }}>
              Managing subcontractor safety shouldn't require chasing paper trails or managing hundreds of external logins. Gain a real-time window into every trade partner on your site.
            </p>
            <div className="trade-feature">
              ...
              <div>
                ...
                <p>With the SALUS Contractor Portal, invite and onboard trades. No account registration, no Salus account required.</p>
              </div>
            </div>
            <div className="trade-feature">
              <div className="trade-feature-icon">
            ...
            <div className="trade-feature">
              ...
              <div>
                <h4>Real-time Visibility <span className="highlight">— at the worker level.</span></h4>
              ...
              <table className="compliance-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><span className="status-badge orientated">Orientated</span></td>
                    <td>12</td>
                    <td>Today, 8:30 AM</td>
                  </tr>
                  <tr>
      ...
      {/* Analytics Section */}
      <section className="section-padding" style={{ background: 'linear-gradient(180deg, hsl(var(--gray-100)) 0%, hsl(var(--background)) 100%)' }}>
        <div className="section-inner grid-2">
          <div className="analytics-card">
            ...
            <div className="analytics-footer">
              <div className="analytics-footer-left">
                ...
                <span>REPORT SHARED WITH <strong>Executive Leadership</strong></span>
              </div>
          ...
          <div>
            ...
            <div className="feature-block">
              ...
              <div>
                ...
                <p>Stop wasting hours opening hundreds of individual PDFs to manually tally incidents in a spreadsheet. Salus indexes every field automatically.</p>
              </div>
            </div>
            <div className="feature-block">
              <div className="feature-block-icon">
              ...
              <div>
                ...
                <p>Spot high-risk trends—like a spike in utility strikes across 50 jobsites—the moment they happen. Move from reactive filing to proactive prevention.</p>
              </div>
            </div>
            <div className="feature-block">
              <div className="feature-block-icon">
              ...
              <div>
                ...
                <p>Deliver clean, professional dashboards to leadership without needing a Power BI developer or expensive analytics add-ons.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="section-inner grid-2">
          <div>
            ...
            <h2 className="section-title">
              ...
              <span className="muted">Built for<br />Safety.</span>
            </h2>
            <p style={{ color: 'hsl(var(--gray-600))', marginBottom: 32 }}>
              Track every piece of equipment, from cranes to drills, with a system designed for the realities of the field. Move beyond financial job costing into real-time fleet health.
            </p>
            <div className="asset-features">
              <div className="asset-feature">
                <div className="asset-feature-icon">
                  <Target size={20} />
                </div>
                <div>
      ...
      {/* Tech Spec Section */}
      <section className="section-padding tech-section" style={{ background: 'hsl(var(--background))' }}>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              ...
              <p className="testimonial-text">
                "SALUS is the perfect marriage of both usability and capability. It has really great features for us as admin, but it's simple for my crews to use out in the field, too."
              </p>
            ...
            <div className="testimonial-card dark">
              <p className="testimonial-text">
                "Before SALUS, we were tracking safety data across 14 different systems—Excel, SharePoint, SiteDocs, you name it. It was unmanageable. Moving to SALUS didn't just digitize us; it unified us."
              </p>
              <div className="testimonial-author">

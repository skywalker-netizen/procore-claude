...
const Root = () => {
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="trust-badges">
              <div className="trust-badge">
                ...
                <div className="trust-text">
                  <strong>All-in-one field ecosystem</strong>
                </div>
              </div>
              <div className="trust-badge">
                <div className="trust-icon beige">
                  <ScanSearch size={22} strokeWidth={2.5} />
                </div>
                <div className="trust-text">
                  <strong>Inspection-ready and audit-proof</strong>
                </div>
              </div>
              <div className="trust-badge">
                <div className="trust-icon" style={{ backgroundColor: '#2d3748', color: 'white' }}>
                  <Rocket size={22} strokeWidth={2.5} />
                </div>
                <div className="trust-text">
                  <strong>Agile deployment</strong>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding field-advantage-section" style={{ background: "hsl(var(--white))" }}>
        <div className="section-inner">
          ...
          <div className="numbered-feature">
            ...
            <div>
              <h4>Not just digital forms; workflows.</h4>
              <p>
          ...
          <div className="numbered-feature">
            ...
            <div>
              <h4>More relevant, better intel</h4>
              <p>
        ...
        <div className="section-inner grid-2">
          <div>
            ...
            <div className="feature-block">
              ...
              <div>
                <h4>Integrated Asset Management</h4>
                <p>
            ...
            <div className="feature-block">
              <div className="feature-block-icon circle lime">
                <Zap size={20} />
              </div>
              <div>
                <h4>Just-in-Time Training</h4>
                <p>
      ...
      <section className="section-padding dark-section trade-partner-section">
        <div className="section-inner grid-2">
          <div className="trade-content">
            <div className="badge">
              <span className="badge-dot"></span>TRADE PARTNER MANAGEMENT
            </div>
            <h2 className="section-title">Full visibility Into Every Trade. Free.</h2>
            <p className="section-subtitle">
      ...
      {/* Actionable Field Intelligence Section */}
      <section className="section-padding" style={{ background: "hsl(var(--gray-100))" }}>
        <div className="section-inner grid-2">
          <div>
            <div className="badge">
              <span className="badge-dot"></span>ACTIONABLE FIELD INTELLIGENCE
            </div>
            <h2 className="section-title">
              Intelligence from the field,
              <br />
              <span className="highlight">for the field.</span>
            </h2>
            <p className="section-subtitle">
              High-Fidelity Field Intelligence helps you prevent incidents and close the accountability gaps. <span className="highlight">At the worker and asset level.</span>
            </p>
            <div className="feature-block">
              <div className="feature-block-icon circle beige">
                <Wrench size={20} />
      ...
      <section
        ...
        style={{ background: "hsl(var(--white))" }}
      >
        <div className="section-inner grid-2">
          ...
          <div>
            <div className="badge">
              <span className="badge-dot"></span>COMPLIANCE & REPORTING
            </div>
            <h2 className="section-title">
            ...
            <div className="feature-block">
              ...
              <div>
                <h4>High-Resolution Compliance</h4>
                    <p>
      ...
      <section className="integration-section">
        <div className="integration-inner">
          <div className="integration-content">
            ...
            <p className="section-subtitle">
              You already have an "enterprise software." You don't need to pay for another. Salus deep native sync means Procore stays your system of record while giving the field a tool they actually love. No double entry. No shadow workflows. Inspections, observations, and personnel data appear exactly where your PMs expect to find them.
            </p>
            ...
            <div className="executive-quote">
              <blockquote>
                "The Procore integration created more tangible value in the form of time back to the field. We eliminated double-entries, gave visibility and access to field reports across the project/business in a uniform and organized fashion all automized, categorized, and in one location."
              </blockquote>
              <cite>
                <strong>Justin Itule</strong>, Field Integration Manager, Willmeng Construction
              </cite>
